/*
 * bench_config.h - Configuration and shared types for rvv-conv assembly benchmarks.
 */
#ifndef RVV_CONV_BENCH_CONFIG_H
#define RVV_CONV_BENCH_CONFIG_H
...
// 1: iterate over CONV_BENCH_PLL_FREQ_LIST frequencies
...
// Comma-separated list used when CONV_BENCH_ENABLE_PLL_SWEEP=1
// #define CONV_BENCH_PLL_FREQ_LIST 50000000ULL, 150000000ULL, 250000000ULL
...
#ifndef CONV_BENCH_ENABLE_F32_3X3
#define CONV_BENCH_ENABLE_F32_3X3 1
#endif

#ifndef CONV_BENCH_ENABLE_F32_5X5
#define CONV_BENCH_ENABLE_F32_5X5 1
#endif

#ifndef CONV_BENCH_ENABLE_I8_3X3
#define CONV_BENCH_ENABLE_I8_3X3 1
#endif

#ifndef CONV_BENCH_ENABLE_I8_5X5
#define CONV_BENCH_ENABLE_I8_5X5 1
#endif
