...
/* Robustness knobs for avoiding hard hangs during stress runs. */
#ifndef DMA_BENCH_SET_MAX_RETRIES
#define DMA_BENCH_SET_MAX_RETRIES 1000000u
#endif

#ifndef DMA_BENCH_WAIT_START_TIMEOUT_CYCLES
#define DMA_BENCH_WAIT_START_TIMEOUT_CYCLES 5000000ULL
#endif

#ifndef DMA_BENCH_WAIT_DONE_TIMEOUT_CYCLES
#define DMA_BENCH_WAIT_DONE_TIMEOUT_CYCLES 50000000ULL
#endif

#ifndef DMA_BENCH_ENABLE_ADDRESS_GATING
#define DMA_BENCH_ENABLE_ADDRESS_GATING 0
#endif
