...
static void conv3x3_pool2x2_acc_1c_rvv(const int8_t *pad,
    ...
    for (int32_t ph = 0; ph < pool_h; ph++) {
        ...
        for (; pw + 1 < pool_w; pw += 2) {
            ...
            const int8_t *q00 = p00 + 2;
            const int8_t *q01 = p00 + 3;
            const int8_t *q10 = p10 + 2;
            const int8_t *q11 = p10 + 3;
            for (int32_t oc0 = 0; oc0 < out_c; ) {
                size_t vl = __riscv_vsetvl_e32m4((size_t)(out_c - oc0));
                ...
                vint32m4_t uacc00 = vbias;
                vint32m4_t uacc01 = vbias;
                vint32m4_t uacc10 = vbias;
                vint32m4_t uacc11 = vbias;
                vint16m2_t vw;
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[0], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[0], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[0], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[0], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 1 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[1], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[1], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[1], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[1], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 2 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[2], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[2], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[2], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[2], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 3 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[pad_w + 0], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[pad_w + 0], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[pad_w + 0], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[pad_w + 0], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 4 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[pad_w + 1], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[pad_w + 1], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[pad_w + 1], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[pad_w + 1], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 5 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[pad_w + 2], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[pad_w + 2], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[pad_w + 2], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[pad_w + 2], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 6 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[(2 * pad_w) + 0], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[(2 * pad_w) + 0], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[(2 * pad_w) + 0], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[(2 * pad_w) + 0], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 7 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[(2 * pad_w) + 1], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[(2 * pad_w) + 1], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[(2 * pad_w) + 1], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[(2 * pad_w) + 1], vw, vl);
                vw = __riscv_vle16_v_i16m2(w16 + 8 * out_c + oc0, vl);
                ...
                uacc00 = __riscv_vwmacc_vx_i32m4(uacc00, q00[(2 * pad_w) + 2], vw, vl);
                uacc01 = __riscv_vwmacc_vx_i32m4(uacc01, q01[(2 * pad_w) + 2], vw, vl);
                uacc10 = __riscv_vwmacc_vx_i32m4(uacc10, q10[(2 * pad_w) + 2], vw, vl);
                uacc11 = __riscv_vwmacc_vx_i32m4(uacc11, q11[(2 * pad_w) + 2], vw, vl);
                ...
                vint32m4_t umax = __riscv_vmax_vv_i32m4(uacc00, uacc01, vl);
                vint32m4_t umax2 = __riscv_vmax_vv_i32m4(uacc10, uacc11, vl);
                umax = __riscv_vmax_vv_i32m4(umax, umax2, vl);
                int32_t *udst = pool_acc + (ph * pool_w + (pw + 1)) + oc0 * pool_hw;
                __riscv_vsse32_v_i32m4(udst, (ptrdiff_t)(pool_hw * (int32_t)sizeof(int32_t)), umax, vl);
                oc0 += (int32_t)vl;
            }
        }
...
Tensor tinyspeech_run_inference_int8(const Tensor *input,
    ...
    float s1 = requant_relu_from_acc_to_padded(g_pool1_acc, TS_L1_OC, TS_L1_PH, TS_L1_PW,
                                               s0, g_w1_scale, g_pad2, TS_L2_OH + 2, TS_L2_OW + 2);
#else
    ...
    float s2 = requant_relu_from_acc_to_padded(g_pool2_acc, TS_L2_OC, TS_L2_PH, TS_L2_PW,
                                               s1, g_w2_scale, g_pad3, TS_L3_OH + 2, TS_L3_OW + 2);
#else
    ...
    float s3 = (s2 * g_w3_scale * (float)max_avg) / 127.0f;
    if (s3 < 1e-20f) {
        s3 = s2 * g_w3_scale;
        if (s3 < 1e-20f) {
            s3 = 1.0f;
...
#else
    float s3 = conv_relu_gap_to_i8(g_act2, s2, w3_conv8, w3_conv16, g_w3_scale, g_bias3_q, g_act3);
#endif
    t1 = rdcycle64_int8();
