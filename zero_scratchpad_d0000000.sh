#!/usr/bin/env bash
#
# zero_scratchpad_d0000000.sh
#
# Writes 0x00000000 across the 16 KiB C2C scratchpad that lives at 0xD000_0000
# (BML25's local scratchpad in the bidirectional Sophia Lake C2C config).
#
# Each word is written with its own uart_tsi invocation, exactly like the
# manual command:
#
#   uart_tsi +tty=/dev/ttyUSB1 +no_hart0_msip +init_write=0xd0000000:0xf00d2f54 +baudrate=921600 none
#
...
BAUD="${BAUD:-921600}"
BASE="${BASE:-0xD0000000}"          # start of the scratchpad
